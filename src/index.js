...
function parse(str) {
  ...
  let stmt = P.string("let").chain(function(_){
  ...
  let atom = num.or(P.string("(").chain(function(lhs){
        return add 
       .skip(P.string(")"))
    }));
